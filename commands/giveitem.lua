...
function command.run(message, mt)
	...
	uj2.consumables[curfilename] = (uj2.consumables[curfilename] == nil) and numitems or
	(uj2.consumables[curfilename] + numitems)
	...
	_G['recievedmessage'] = formatstring(lang2.recieved_message, { uj.id, numitems, cdb[curfilename].name },
		lang.plural_s)
